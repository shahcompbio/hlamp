...
def plot_histogram(figPath=None, final_ndna=None, figsize=(12, 3), show_KDE=False):
    ...
    # Define a cutoff for the tail of the distribution
    ...
    sns.histplot(
        final_ndna[final_ndna > the_mean], bins=nbins, kde=show_KDE, ax=axes[1]
    )
...
def plot_subsample_histogram(
    figPath=None, final_ndna=None, figsize=(12, 4), n_samples=1000, show_KDE=False
):
    # Random subsample
